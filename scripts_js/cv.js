...
function loadProfessionalContent(defaultProject) {
  ...
  menuItems.forEach((link) => {
    link.addEventListener('click', (event) => {
      ...
      professionalText.innerHTML = projects[link.textContent.trim()] || '';
    });
  });
